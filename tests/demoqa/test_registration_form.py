...
def test_successful():
    ...
    options.capabilities.update(selenoid_capabilities) #апдейт словаря

    driver = webdriver.Remote(
        command_executor="https://user1:1234@selenoid.autotests.cloud/wd/hub", #user1:1234@ юзер пароль
        options=options)
